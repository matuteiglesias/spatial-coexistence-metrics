...
class ProductSpace(D3PlusViz):
    ...
    HS_GRAPH_DATA = open(os.path.join(path, "./atlas_international_product_space_hs4_codes.json")).read()
    SITC_GRAPH_DATA = open(os.path.join(path, "./atlas_international_product_space_sitc_codes.json")).read()
